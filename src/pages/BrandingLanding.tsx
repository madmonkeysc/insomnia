...
export const BrandingLanding = () => {
  const { t } = useLanguage();
  const { setIsBookingModalOpen } = useGlobalContext();
  const s = (t.services as any).service2;
        ...
        <section className="mb-32">
          ...
          >
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 drop-shadow-[0_0_40px_rgba(34,211,238,0.4)]">
            ...
            >
              <button 
                ...
                className="group relative px-12 py-6 bg-cyan-600 rounded-full font-black overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_50px_rgba(8,145,178,0.4)]"
              >
              ...
              <div className="space-y-10">
                <div className="flex justify-between items-end border-t border-white/10 pt-10">
                  <div className="space-y-2">
                    <p className="text-[10px] text-zinc-500 font-mono tracking-[0.3em] uppercase">SYSTEM_STATE</p>
                    <p className="text-2xl font-mono tracking-tighter text-cyan-400">EVOLVING_IDENTITY</p>
                  </div>
                  <div className="text-right space-y-2">
                    <p className="text-[10px] text-zinc-500 font-mono tracking-[0.3em] uppercase">SYNC_LEVEL</p>
                ...
                <div className="h-4 w-full bg-white/5 rounded-full overflow-hidden p-1 border border-white/10">
                  <motion.div 
                    ...
                    className="h-full bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600 rounded-full shadow-[0_0_30px_rgba(34,211,238,0.6)]" 
                  />
                </div>
              </div>
            </motion.div>
            ...
            {s.feats?.map((feat: any, i: number) => (
              ...
              >
                ...
                <div className="w-16 h-16 rounded-2xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400 group-hover:scale-110 group-hover:bg-cyan-500/20 transition-all duration-500 mb-8">
                  {i === 0 && <Palette size={32} strokeWidth={1.5} />}
                  {i === 1 && <Target size={32} strokeWidth={1.5} />}
          ...
          <div className="grid lg:grid-cols-5 gap-0 rounded-[4rem] border border-white/10 overflow-hidden bg-zinc-900/20 backdrop-blur-3xl shadow-2xl">
            <div className="lg:col-span-3 p-12 lg:p-20 space-y-16 lg:border-r border-white/10 text-left">
              ...
              <motion.div 
                ...
                className="p-10 rounded-[2.5rem] bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-transparent border border-cyan-500/20 flex flex-col sm:flex-row gap-8 items-center text-center sm:text-left"
              >
                <div className="w-20 h-20 rounded-full bg-cyan-500 flex items-center justify-center flex-shrink-0 shadow-[0_0_40px_rgba(6,182,212,0.5)]">
            ...
            <div className="flex flex-col xl:flex-row items-center justify-between gap-16 relative z-10">
              <div className="space-y-8">
                ...
                <h3 className="text-6xl md:text-8xl font-black italic uppercase tracking-tighter leading-[0.85]">
                  {s.promo.title} <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-500 drop-shadow-2xl">
                    {s.promo.highlight}
                  </span>
                </h3>
          ...
          >
            <div className="relative">
              ...
              <h3 className="text-6xl md:text-[10rem] font-black uppercase italic tracking-tighter leading-[0.8] relative">
                {s.finalTitle1} <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600 drop-shadow-[0_0_50px_rgba(34,211,238,0.3)]">
            ...
            <div className="space-y-12 relative flex flex-col items-center">
              ...
              <button 
                onClick={() => setIsBookingModalOpen(true)}
                className="group relative px-20 py-10 bg-cyan-600 rounded-[3rem] font-black tracking-[0.4em] uppercase overflow-hidden shadow-[0_10px_80px_rgba(8,145,178,0.4)] hover:shadow-cyan-500/60 transition-all duration-700 transform active:scale-95 text-2xl"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-600 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
